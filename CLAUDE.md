...
uv run europeana-qlever -d WORK_DIR list-queries                 # List all 35 available queries
...
uv run europeana-qlever -d WORK_DIR export --query-set all       # Export all 35 queries
