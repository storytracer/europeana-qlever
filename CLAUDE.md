...
src/europeana_qlever/
  ...
  report_questions/                # Bundled default report question YAML files (copied to workdir by write-report-config)
    ...
    volume.yml                     # Volume & composition questions (8)
    rights.yml                     # Rights distribution questions (2)
    language.yml                   # Language coverage questions (2)
    completeness.yml               # Metadata completeness questions (2)
    entities.yml                   # Entity enrichment questions (5)
    content.yml                    # Content accessibility questions (2)
