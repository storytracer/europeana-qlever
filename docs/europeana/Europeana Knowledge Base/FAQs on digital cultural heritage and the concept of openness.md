...
> [!NOTE]
> This page has been created by the [Europeana Copyright Community](https://pro.europeana.eu/page/europeana-copyright) Steering Group.
>
> Use it to understand more about the concept of ‘open’, which plays a key role in digital cultural heritage, but has many dimensions.

- [What does ‘open’ mean in a general sense?](#what-does-open-mean-in-a-general-sense)
- [What does ‘open access’ mean?](#what-does-open-access-mean)
- [What do open GLAM and open content mean?](#what-do-open-glam-and-open-content-mean)
- [What does open data mean?](#what-does-open-data-mean)
- [What are the FAIR principles, and how do they link to open data?](#what-are-the-fair-principles-and-how-do-they-link-to-open-data)
- [Is all content made available online ‘open’?](#is-all-content-made-available-online-open)
- [Why is some content ‘open’ and some not?](#why-is-some-content-open-and-some-not)
- [Is it appropriate for some materials to remain ‘closed’?](#is-it-appropriate-for-some-materials-to-remain-closed)
- [Can content move from being ‘closed’ to ‘open’ or vice versa?](#can-content-move-from-being-closed-to-open-or-vice-versa)
- [What are open licences? Are all Creative Commons licences open?](#what-are-open-licences-are-all-creative-commons-licences-open)
- [Are Right Statements by the Rights Statements Consortium ‘open’?](#are-right-statements-by-the-rights-statements-consortium-open)
- [How does the Europeana Initiative promote ‘openness’ of digital cultural heritage in the common European data space for cultural heritage?](#how-does-the-europeana-initiative-promote-openness-of-digital-cultural-heritage-in-the-common-european-data-space-for-cultural-heritage)

## What does ‘open’ mean in a general sense?

The term ‘open’ is used to refer to information and tools which are accessible and reusable to a large extent. In a general sense, when these materials are marked as ‘[open](https://opendefinition.org/od/2.1/en/)’ anyone is free to access, use, modify and share them for any purpose, subject, at most, to measures that preserve provenance and openness.
...
The term ‘[open access](https://www.budapestopenaccessinitiative.org/read/)’ has a specific context compared to other movements. Originally, the idea of Open Access (OA) as conceived by the 2002 [Budapest Declaration](https://www.budapestopenaccessinitiative.org/read/) and the Berlin and 2003 Bethesda Declarations, which referred to:
...
*For example, the cultural heritage organisation owns the copyright, or has permission from the rightsholder to the content and decides to make it available under a* [*CC BY 4.0*](https://creativecommons.org/licenses/by/4.0/) *(Attribution) licence.*
...
For more information, check our page on [Open and Reusable Cultural Heritage](https://pro.europeana.eu/index.php/page/open-and-reusable-digital-cultural-heritage) and read our [Public Domain Charter](https://pro.europeana.eu/index.php/post/the-europeana-public-domain-charter).
...
The open data movement has been strongly fuelled by the open government movement, advocating for transparency and reusability of public sector information. As a result, some legal provisions establish open data obligations in the area of public sector information. At the EU level, the legal regime of Open Data is regulated in the Public Sector Information/[Open Data Directive (EU) 2019/1024](https://eur-lex.europa.eu/eli/dir/2019/1024/oj) which mostly tackles the free accessibility and reuse of data gathered by public sector organisations (such as state bodies), and in some limited cases - data handled by universities and research organisations, resulting from publicly funded research.

For example, in 2019 the European Commission [adopted](https://creativecommons.org/2019/04/02/european-commission-adopts-cc-by-and-cc0-for-sharing-information/) the use of [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) and [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) for sharing information. At the national level, governments have been relying on the same or similar standards to release public sector information.

---

## What are the FAIR principles, and how do they link to open data?

[Open data](https://opendatahandbook.org/guide/en/what-is-open-data/) often involves a strong technological dimension, such as the need to make data machine-readable, or to structure the data so that it can be linked with other data (linked open data). Thus, the requirements associated with opening data to the public cover not only legal, but also technical considerations. A term that is closely linked to open data is [FAIR (Findable, Accessible, Interoperable, and Reusable)](https://www.go-fair.org/fair-principles/), which is widely used in the scientific world for research data. While FAIR principles and sub-principles include openness, they go further by specifically focusing on improving the accessibility and usability of data, without necessarily requiring openness in the broader research methodology. The FAIR principles do not explicitly address legal aspects such as licensing, leaving it to external considerations. FAIR also relates to broader concepts to openness in research, including methods, publications, licensing, community engagement and ethics.

An important counterpart to the FAIR Principles include the [CARE Principles](https://static1.squarespace.com/static/5d3799de845604000199cd24/t/6397b363b502ff481fce6baf/1670886246948/CARE%2BPrinciples_One%2BPagers%2BFINAL_Oct_17_2019.pdf) for Indigenous Data Governance. CARE refers to Collective Benefit, Authority to Control, Responsibility and Ethics involved in ensuring that Indigenous peoples and individuals are able to assert greater control over the application and use of Indigenous data and Indigenous knowledge held by cultural heritage institutions and other organisations.

To read more about the topic, check the page [Europeana and the FAIR principles for research data](https://pro.europeana.eu/post/europeana-and-the-fair-principles-for-research-data) and the Global Indigenous Data Alliance’s website on how to [#BeFAIRandCARE](https://www.gida-global.org/care).
...
Among the CC suite of licences for copyright materials, those that are open include [CC BY](https://creativecommons.org/licenses/by/4.0/) and [CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/).
...
The [Rights Statements](https://rightsstatements.org/en/) created by the Rights Statements Consortium are a set of labels of the reuse conditions of a work in a standardised form. They refer to copyright limitations, but they also inform users of relevant legal or contractual restrictions.
...
- The [Europeana Public Domain Charter](https://pro.europeana.eu/post/the-europeana-public-domain-charter), through which we advocate for public domain content to remain in the public domain after digitisation.
- The [Europeana Publishing Framework](https://pro.europeana.eu/post/publishing-framework), which introduces four tiers of criteria for measuring content quality by taking into account not just the quality of the digital resources, but also the degree of openness in the Rights Statements and CC Licences and Tools applied to them.

You can read more about how Europeana support openness on this [page](https://pro.europeana.eu/page/open-and-reusable-digital-cultural-heritage).
