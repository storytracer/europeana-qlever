...
| **1**    | Working edm:isShownAt | [Any of the available rights statements](https://pro.europeana.eu/page/available-rights-statements) |

For example records per edm:type = AUDIO, see page [Example records - content & metadata tiers](../Example%20records%20-%20content%20&%20metadata%20tiers.md) .

### Related articles

- Page:

  [ContentTier 1:  Audio type](ContentTier%201_%20%20Audio%20type.md)
- Page:
