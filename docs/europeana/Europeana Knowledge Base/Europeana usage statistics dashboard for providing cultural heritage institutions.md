...
The following guidance will help you to get the most out of your institution's dashboard which shows how Europeana’s audience are interacting with your institution's content on Europeana.eu. To see how much of your institution's content is on Europeana.eu then you can use our separate [data statistics dashboard product.](https://docs.google.com/document/d/1xaJFbBSw-PoRococsIlq4gM62IVsLfeifrV7fGiyK-U/edit#heading=h.b9n2ghfptjfl)

- [Receiving your dashboard](#receiving-your-dashboard)
- [About the dashboard](#about-the-dashboard)
- [Your institution's databoard](#your-institution-s-databoard)
  - [Total no. of visits](#total-no-of-visits)
  - [Average Time](#average-time)
  - [Bounce Rate](#bounce-rate)
  - [Page Views](#page-views)
- [The Europeana Board](#the-europeana-board)
  - [Total number of visitors](#total-number-of-visitors)
  - [Page Views](#page-views)
  - [Average time on site](#average-time-on-site)
  - [Bounce Rate](#bounce-rate)
  - [Downloads](#downloads)
  - [Click-through to provider website](#click-through-to-provider-website)
  - [Visits by country](#visits-by-country)
  - [Visits by channel](#visits-by-channel)
- [Where does the data come from?](#where-does-the-data-come-from)
- [What’s next?](#what-s-next)

## **Receiving your dashboard**

You can request a usage statistics dashboard for your institution by filling in the form in the [Europeana Welcome Pack](https://www.europeana.eu/en/share-your-data#register-to-get-the-most-out-of-europeana).
...
The data we display comes from Matomo, which we use at the Europeana Foundation to track the usage of our website Europeana.eu. Matomo is an open source product which is widely used by many EU institutions to track visitors to their websites. You can read more about Matomo [here](https://matomo.org/guides/).

The dashboard is made with a specialised product called [Databox](https://databox.com/), which is developed by an external provider. Databox pulls the data from Matomo, so you can see the live insights into the usage of your institution's data on Europeana.
