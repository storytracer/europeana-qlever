...
- [1 What is the Europeana Metis Sandbox?](#key-1-what-is-the-europeana-metis-sandbox)
  - [1.2 Who are the intended users of the Metis Sandbox?](#key-1-2-who-are-the-intended-users-of-the-metis-sandbox)
  - [1.3 What will you learn in this training?](#key-1-3-what-will-you-learn-in-this-training)
  - [1.4 How will you learn this?](#key-1-4-how-will-you-learn-this)
  - [1.5 What will you need?](#key-1-5-what-will-you-need)
- [2 Upload a dataset](#key-2-upload-a-dataset)
  - [2.1 Upload a local zip file in EDM format](#key-2-1-upload-a-local-zip-file-in-edm-format)
    - [2.1.1 Create a new dataset](#key-2-1-1-create-a-new-dataset)
    - [2.1.2 Specify and upload the dataset](#key-2-1-2-specify-and-upload-the-dataset)
    - [2.1.3 Processing the dataset](#key-2-1-3-processing-the-dataset)
    - [2.1.4 Review the dataset (basic review)](#key-2-1-4-review-the-dataset-basic-review)
    - [2.1.5 Test your knowledge](#key-2-1-5-test-your-knowledge)
  - [2.2 Upload a file on a web server in EDM format](#key-2-2-upload-a-file-on-a-web-server-in-edm-format)
    - [2.2.1 Create a new dataset](#key-2-2-1-create-a-new-dataset)
    - [2.2.2 Specify and upload the dataset](#key-2-2-2-specify-and-upload-the-dataset)
    - [2.2.3 Processing the dataset](#key-2-2-3-processing-the-dataset)
    - [2.2.4 Review the dataset](#key-2-2-4-review-the-dataset)
  - [2.3 Upload a local zip file not in EDM format](#key-2-3-upload-a-local-zip-file-not-in-edm-format)
    - [2.3.1 Create a new dataset](#key-2-3-1-create-a-new-dataset)
    - [2.3.2 Specify and upload the dataset](#key-2-3-2-specify-and-upload-the-dataset)
    - [2.3.3 Processing the dataset](#key-2-3-3-processing-the-dataset)
    - [2.3.4 Review the dataset](#key-2-3-4-review-the-dataset)
- [3 Track a dataset and preview in Europeana](#key-3-track-a-dataset-and-preview-in-europeana)
  - [3.1 Track a dataset](#key-3-1-track-a-dataset)
    - [3.1.1 Enter the dataset ID](#key-3-1-1-enter-the-dataset-id)
    - [3.1.2 Preview the dataset on Europeana](#key-3-1-2-preview-the-dataset-on-europeana)
  - [3.2 View a record report](#key-3-2-view-a-record-report)
    - [3.2.1 Open a record report](#key-3-2-1-open-a-record-report)
    - [3.2.2 Review a record report](#key-3-2-2-review-a-record-report)
    - [3.2.3 Compare records before and after enrichment](#key-3-2-3-compare-records-before-and-after-enrichment)
  - [3.3 Test your knowledge](#key-3-3-test-your-knowledge)
  - [3.4 Problem patterns](#key-3-4-problem-patterns)
  - [3.5 Test your knowledge](#key-3-5-test-your-knowledge)
- [4. End of training and satisfaction survey](#key-4-end-of-training-and-satisfaction-survey)
...
7. The [Metis Sandbox User Guide](Metis%20Sandbox%20User%20Guide.md) for reference. You can use the user guide whenever you want to look up more information about the Sandbox.
...
1. 🖱 Click on [this link](https://drive.google.com/file/d/1jl0OjdK9lfaQyx7BI3VKaqfe2-x0C_Cu/view?usp=sharing) to go to the files for exercise 2.3.
2. 🖱 Click on the download button in the top right corner to download the files as a zip file.
...
OAI-PMH harvesting is currently excluded from this training, please contact [Henning Scholz](https://pro.europeana.eu/person/henning-scholz) if you would like to recieve more information about this option.
...
📂 You need the dataset *Sandbox\_Training\_Files\_2.1.zip* for this exercise.
...
4. 🖱 Click on the button left of **“No file chosen”** and select the sample file named *Sandbox\_Training\_Files\_2.1.zip* that you downloaded in 1.5 of this training.
...
> [!IMPORTANT]
> For educational reasons, several mistakes are included in this set. This test set is based on [an original dataset of Leiden University Libraries](https://www.europeana.eu/nl/search?page=1&view=grid&query=edm_datasetName%3A640_%2A) which does not have these mistakes.
...
> [!NOTE]
> Don’t forget to press ‘view score’ once you have submitted your answers! You will then see the answers to the questions and an explanation.
...
1. Open the <https://metis-sandbox.europeana.eu/> if you do not have it open yet.
2. Create a new dataset by clicking on the “**create new dataset**” link.
...
4. Copy and paste the following URL in the URL text box: [**http://ftp.eanadev.org/uploads/Sandbox\_Training\_Files\_2.2.zip**](http://ftp.eanadev.org/uploads/Sandbox_Training_Files_2.2.zip)
...
📂 You need the files *BnF\_test\_Sandbox.zip* and *BnF\_Manuscripts.xsl* for this exercise.
...
2. 🔽 Select a random Country and random Language from the drop down menus.
3. 🔘 Under Harvest Protocol, select **“File upload”** if this is not selected.
4. 🖱 Click on the button left of **“No file chosen”** and select the sample file named *BnF\_test\_Sandbox.zip* that you downloaded in 1.5 of this training.
...
6. 🖱 Click on the button left of **“No file chosen”** and select the sample file named *BnF\_Manuscripts.xsl* that you downloaded in 1.5 of this training.
...
> [!IMPORTANT]
> For educational reasons, a mistake is included in this set. This test set is based on a dataset and XSLT file of the [National Library of France](https://www.europeana.eu/nl/collections/organisation/1482250000002112001-national-library-of-france) which did not have any mistakes.
...
The Sandbox allows you to get a preview of what your dataset would look like on Europeana.eu and review the problem patterns identified for it. You will also be able to get insight in the [Content Tiers](https://pro.europeana.eu/post/publishing-framework#content-tiers) and [Metadata Tiers](https://pro.europeana.eu/post/publishing-framework#metadata-tiers) of individual records.
...
> [!WARNING]
> It takes up to 15 minutes for previews to generate. If the objects are not shown yet, please wait a few more minutes.
...
> [!WARNING]
> For this exercise you will need to view the page source of web page in your browser. This is supported by most desktop browsers, but it varies per browser how to get this to show. Depending on your browser you might need an xml plugin to improve the readability.
...
>
> 1. 🔍 **Find the record** with the **non-critical error** (see 2.1.4. for details).
> 2. 📝 **Create a record report** for this record.
> 3. 👁 **Review** the *Content Tier Breakdown* for this record.
...
The various problem patterns that the application can detect are described in detail in the [Metis Sandbox User Guide](#metis-sandbox-user-guide).
...
Thank you for taking the time to complete this training. Could you share your satisfaction by filling out the survey below? For any questions about this training or to share your feedback in detail, please contact [Sebastiaan ter Burg](https://pro.europeana.eu/person/sebastiaan-ter-burg). More information about the process to publish your data can be found on [Europeana Pro](https://pro.europeana.eu/share-your-data/process).
