...
- [1 Introduction](#key-1-introduction)
  - [1.1 Why we made this guide](#key-1-1-why-we-made-this-guide)
  - [1.2 Who this guide is for](#key-1-2-who-this-guide-is-for)
  - [1.3 How to use this guide](#key-1-3-how-to-use-this-guide)
  - [1.4 Definitions](#key-1-4-definitions)
- [2 Development process](#key-2-development-process)
- [A. Needs determination](#a-needs-determination)
  - [A.1 Practical: User demand](#a-1-practical-user-demand)
  - [A.2 Strategic](#a-2-strategic)
- [B. Inventorisation](#b-inventorisation)
  - [B.1 Impact](#b-1-impact)
  - [B.2 Users and use cases](#b-2-users-and-use-cases)
    - [B.2.1 Group size](#b-2-1-group-size)
  - [B.3 Intended learning outcomes](#b-3-intended-learning-outcomes)
    - [B.3.1 Establish ILOs](#b-3-1-establish-ilos)
    - [B.3.2 Validation of ILOs](#b-3-2-validation-of-ilos)
  - [B.4 Learning pathways](#b-4-learning-pathways)
    - [B.4.1 Prerequisites and follow up](#b-4-1-prerequisites-and-follow-up)
  - [B.5 Training resources](#b-5-training-resources)
    - [B.5.1 Existing resources](#b-5-1-existing-resources)
    - [B.5.2 New training resources](#b-5-2-new-training-resources)
    - [B.5.3 Update frequency](#b-5-3-update-frequency)
  - [B.6 Timeline and actions](#b-6-timeline-and-actions)
  - [B.7 Contact information](#b-7-contact-information)
  - [B.8 Template review](#b-8-template-review)
    - [B.8.1. Fit with existing curriculum](#b-8-1-fit-with-existing-curriculum)
- [C. Development stages](#c-development-stages)
  - [C.1 Pre-alpha stage](#c-1-pre-alpha-stage)
    - [C1.1 Internal vs external](#c1-1-internal-vs-external)
  - [C.2 Alpha stage](#c-2-alpha-stage)
    - [C.2.1 Written training](#c-2-1-written-training)
    - [C.2.2 Exercises](#c-2-2-exercises)
    - [C.2.3 Images and illustrations](#c-2-3-images-and-illustrations)
    - [C.2.4 Advertising and delivery of training](#c-2-4-advertising-and-delivery-of-training)
    - [C.2.5 Gathering feedback](#c-2-5-gathering-feedback)
  - [C.3 Beta stage](#c-3-beta-stage)
    - [C.3.1 Creating additional training resources](#c-3-1-creating-additional-training-resources)
    - [C.3.2 Advertising and delivery of the training](#c-3-2-advertising-and-delivery-of-the-training)
    - [C.3.4 Gathering feedback](#c-3-4-gathering-feedback)
    - [C.3.5 Processing feedback](#c-3-5-processing-feedback)
  - [C.4 V1 Public](#c-4-v1-public)
    - [C.4.1 Guidelines and checks](#c-4-1-guidelines-and-checks)
    - [C.4.2 Publication and findability](#c-4-2-publication-and-findability)
- [D. Training delivery](#d-training-delivery)
  - [D.1 Instructor-led training](#d-1-instructor-led-training)
    - [D.1.1 Setting up a Europeana training event](#d-1-1-setting-up-a-europeana-training-event)
    - [D.1.2 Training at external events](#d-1-2-training-at-external-events)
  - [D.2 Self paced training](#d-2-self-paced-training)
  - [D.3 Training progress](#d-3-training-progress)
  - [D. 4 Certification](#d-4-certification)
  - [D.5 Scaling up training](#d-5-scaling-up-training)
    - [D.5.1 Train the trainer](#d-5-1-train-the-trainer)
    - [D.5.2 Translation and localisation](#d-5-2-translation-and-localisation)
    - [D.5.3 Extend Learning pathways](#d-5-3-extend-learning-pathways)
- [E. Measuring training impact](#e-measuring-training-impact)
- [F. Upkeep and improvement](#f-upkeep-and-improvement)
- [G. Contact](#g-contact)
...
1. Technical tools, like the [Metis Sandbox Training](../Metis%20Sandbox%20Training.md) and [Data Statistics Dashboard](https://pro.europeana.eu/page/europeana-data-statistics-dashboard-training)
2. Rights (for example [determining copyright](https://pro.europeana.eu/page/identifying-copyright-in-collection-items) and [selecting appropriate rights statements](https://pro.europeana.eu/page/selecting-a-rights-statement))
3. Diversity & Inclusion, like the [facilitators guide](https://pro.europeana.eu/files/Europeana_Professional/Event_documentation/Events/Europeana_GS_meeting/WEAVE-workbook.pdf) developed for a D&I workshop that was developed for the WEAVE project
...
The definitions used in this document can be found in [the glossary on Europeana Pro](https://pro.europeana.eu/page/glossary) and in the annex.
...
We have produced a  [Training Development Template](https://docs.google.com/document/d/1j2ZlOrcog-WlEmivz7_h_Ca_DLyM4HNa8sEC9DFuCig/edit) which asks you the most important questions to consider before the development of training can be started. Make a copy of the [Template](https://docs.google.com/document/d/1j2ZlOrcog-WlEmivz7_h_Ca_DLyM4HNa8sEC9DFuCig/edit) and fill it in as much as possible. This template can be your own reference document when you are developing the training yourself, but it can also function as a central document for a meeting with a training development expert to determine your needed support. The template asks you to think about the following questions:
...
|                               |                                                                                    |
|:------------------------------|:-----------------------------------------------------------------------------------|
| **Type of training material** | **Examples**                                                                       |
| Reference material            | User guides, instruction manuals                                                   |
| Instructions                  | Written instructions, images, slide decks, audio instructions, instruction videos, |
| Validation                    | Exercises, quizzes                                                                 |
| Scaling up training           | Facilitator guides                                                                 |
...
|           |                                                                                                              |                |                         |                                       |
|:----------|:-------------------------------------------------------------------------------------------------------------|:---------------|:------------------------|:--------------------------------------|
| **Stage** | **Outcome(s)**                                                                                               | **Language**   | **Learning styles**     | **Platform(s)**                       |
| Pre-alpha | Documentation (user guides, manuals, etc)                                                                    |                |                         |                                       |
| Alpha     | Internally tested written documentation and exercises, with illustrations and pictures                       | One language   | Reading & Writing (R&W) |                                       |
| Beta      | Improved alpha material that is externally tested written, possibly complemented by an introduction video    | One language   | R&W                     |                                       |
| V1 Public | Improved, externally tested beta material with final check on language and design. Any videos are subtitled. |                | R&W                     | Pro (findable through / published on) |
| V2        | Explainer video for relevant chapters with subtitles                                                         |                | R&W, Auditory           | Pro (findable through / published on) |
| V3        | Translation of documentation and subtitles                                                                   | Two+ languages | R&W, Auditory           | Pro (findable through / published on) |
| V…        |                                                                                                              | Sign language  |                         | Pro (findable through / published on) |

*More information on accessibility is given in paragraph* [Guidelines for delivering training and development - Full guide](Guidelines%20for%20delivering%20training%20and%20development%20-%20Full%20guide.md)*. **Learning styles** refer to a range of theories that aim to account for differences in individuals' learning. In this guide the VARK theory is being used. Also see the* [*Wikipedia page on learning styles*](https://en.wikipedia.org/wiki/Learning_styles#Neil_Fleming's_VAK/VARK_model) *for more information and resources.*
...
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Relate, Tell, Show, Do, Review** <br/> There are many different approaches for the delivery of training. All with their respective advantages and disadvantages. Relate, Tell, Show, Do, and Review is an effective method to design training for task competency, skill development and behavioural change. It allows learners to construct knowledge rather than just passively absorb information. <br/> **Relate** <br/> A concept is more accessible when someone can relate to it. This allows learners to see practical uses instead of thinking purely conceptually. One approach to make training topics more relatable is to include use cases of the topic your training discusses. Use cases describe real world or fictional people, relevant details about their roles and responsibilities and how they are using the skills, knowledge or competencies of your training. <br/> **Tell** <br/> Now that your learners can relate to your training topic, it is time to start the training. Explain what you are going to do, why you are doing it and what you want learners to pay attention to. This prepares them for the actual training activity. <br/> **Show** <br/> After telling what they are going to learn, it is time for a demonstration. A demonstration can be live or pre-recorded. It can be visual, for example when you are teaching people how to use a piece of software, but it can also be audible, like roleplaying ([Guidelines for delivering training and development - Full guide](Guidelines%20for%20delivering%20training%20and%20development%20-%20Full%20guide.md) goes into more detail on this topic). <br/> **Do** <br/> Learners should be given an opportunity to practice while they are learning. This allows them to really absorb what has been told and demonstrated. It also allows a trainer to see what parts of the instructions people remember or struggle with. ‘Learning by doing’ is one of the most effective, and most forgotten, ways of teaching. The time needed for this phase depends on the overall design of your training, it can vary between 20% to 50% of the total training time. <br/> **Review** <br/> The review stage is a check to establish if the learning goals have been met. This can be done in different ways, from showing results, giving each other feedback to gamified questionnaires. The topic you are training people in determines the available methods. The review stage is also ideal to reiterate what has been discussed so far, from relating to the topic to applying new skills, knowledge or competencies in the doing phase. |
...
|:------------------------------------------------------|:------------------------------------------|:---------------------------------------------------------------------------------------------------|
|                                                       | **Type of training**                      |                                                                                                    |
| **Type of assessment**                                | **In person training**                    | **Online training**                                                                                |
| Self evaluation, based on quizzes and questions <br/> | Offline or online forms (see next column) | Online forms, for example Google forms, Mentimeter, Surveymonkey, Kahoot                           |
| Peer review by fellow trainees                        | Small group discussion, written feedback  | Small group discussion (possibly in a breakout room), written feedback (supported by online forms) |
| On-the-job observation                                | In person observation, role playing       | Screen sharing, role playing                                                                       |
| Feedback from an instructor                           | One on one meeting or written feedback    | One on one meeting or written feedback                                                             |

**Time for reflection**

Make sure to look back at the impact ([Guidelines for delivering training and development - Full guide](Guidelines%20for%20delivering%20training%20and%20development%20-%20Full%20guide.md)) and Intended Learning Outcomes ([Guidelines for delivering training and development - Full guide](Guidelines%20for%20delivering%20training%20and%20development%20-%20Full%20guide.md)) to design the exercises. This is also a good moment to reflect on the intake process. Are the impact and ILOs still relevant? Or do they need revision based on the learnings of working on the pre-alpha and alpha stage of the training?
...
Apart from the above: communicate that you’ll be asking for additional feedback to improve the training. See the alpha stage ([Guidelines for delivering training and development - Full guide](Guidelines%20for%20delivering%20training%20and%20development%20-%20Full%20guide.md)) for the things to consider for the delivery of the training.
...
There are many different accessibility guidelines to consider for training. An extensive overview can be found on this [W3 web page on standards and guidelines](https://www.w3.org/WAI/standards-guidelines/). Europeana content should comply with [WCAG2.1 Level AA](https://www.w3.org/WAI/WCAG21/quickref/). For more information also see [Europeana’s accessibility policy](https://www.europeana.eu/en/rights/accessibility-policy).

---

### **C.4.2 Publication and findability**

Europeana Pro is the main channel for publishing Europeana’s training material. Videos, quizzes and other content can be embedded on Pro. Technical training specifically targeted at aggregators can potentially be published on the [Europeana Knowledge Base](/wiki/spaces/EF). Please contact [Nicholas Jarret](https://pro.europeana.eu/person/nicholas-jarrett) or [Georgia Evans](https://pro.europeana.eu/person/georgia-evans) to discuss the options for publication.
...
- Social media posts
- Organising your own training sessions (see [Guidelines for delivering training and development - Full guide](Guidelines%20for%20delivering%20training%20and%20development%20-%20Full%20guide.md)).
...
Training can be delivered using existing tools and services. At Europeana this means that Europeana Pro may be used to advertise and communicate about the opportunities. Knowledge base and Google Drive may be used for documentation. Training resources developed with partner organisations or within projects can be offered on their respective websites too. Reach out to our [event coordinator,](https://pro.europeana.eu/person/gina-van-der-linden) to discuss setting up your event.

Extensive information about running events can be found in [Europeana’s Events Toolkit.](https://pro.europeana.eu/page/events-toolkit)

### **D.1.2 Training at external events**

Make sure that your event is added to the Europeana calendar by filling in [this events form.](https://app.smartsheet.com/b/form/84546d814bad4e0e96c3b98a2f102c69)

## **D.2 Self paced training**

Self paced training requires training resources to be published and monitored. This is described in [Guidelines for delivering training and development - Full guide](Guidelines%20for%20delivering%20training%20and%20development%20-%20Full%20guide.md), E and F respectively.
...
In the intake form you have determined the impact of your training too (See [Guidelines for delivering training and development - Full guide](Guidelines%20for%20delivering%20training%20and%20development%20-%20Full%20guide.md) and [Guidelines for delivering training and development - Full guide](Guidelines%20for%20delivering%20training%20and%20development%20-%20Full%20guide.md)). If you want to ask more feedback from the trainees to measure this impact, then make sure to have a look at the [Europeana Question Bank](https://pro.europeana.eu/page/europeana-standardised-question-bank) for possible standardised questions.
...
The need to update training resources can also be triggered by changes you already anticipate. An example of this is the update of software. If this is the case, make sure that you start the development of the updated training resources alongside the development and deployment of the software update, (also see the first paragraph of [Guidelines for delivering training and development - Full guide](Guidelines%20for%20delivering%20training%20and%20development%20-%20Full%20guide.md)). Now that you have gone through the entire process, you should be able to identify the needed steps for your training updates, from updating user manuals to instructing other trainers about the changes.
...
For questions about this guide, suggestions for improvements and request for support, please contact [Sebastiaan ter Burg.](https://pro.europeana.eu/person/sebastiaan-ter-burg)
